...
Most contest names are associated with three of fewer candidates suggesting that contest names identify unique contests within counties.
...
Nothing here immediately jumps out as suggesting that multiple contests in a county are have the same `contest` field value.
